...
public class TipoviZahteva implements Serializable {
    ...
    public static final int DODAJ_NOVO_ZAKAZIVANJE_TERMINA_ZAHTEV = 6;
    public static final int OBRISI_ZAKAZIVANJE_TERMINA_ZAHTEV = 7;
    public static final int IZMENI_KOZMETICARA_ZAHTEV = 8;
    public static final int PRETRAZI_USLUGE_ZAHTEV = 9;
    public static final int IZMENI_ZAKAZIVANJE_TERMINA_ZAHTEV = 10;
    ...
    public static final int VRATI_ZAKAZIVANJA_TERMINA_ZAHTEV = 15;
}
